...
education.display = function (){
	...
	for(var schools in this.schools){
		var formattedSchoolName = HTMLschoolName.replace("%data%", this.schools[schools].name);
		var formattedSchoolDegree = HTMLschoolDegree.replace("%data%", this.schools[schools].degree);
	...
	for(var olClasses in this.onlineCourses){
		var formattedOlTitle = HTMLonlineTitle.replace("%data%", this.onlineCourses[olClasses].title);
		var formattedOlSchool = HTMLonlineSchool.replace("%data%", this.onlineCourses[olClasses].school);
	...
	"jobs" : [
		{
			...
			"description" : "Building and maintaining systems for a data processing department at an international mailhouse"
		} ,
		{
			"employer" : "Air Business Ltd",
